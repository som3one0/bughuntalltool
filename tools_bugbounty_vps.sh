...
mkdir -p /root/ALLInOne/tools /root/ALLInOne/tools/file /root/wordlist /root/templates;
clear;
...
SUBDOMAINS_ENUMERATION () {
	...
	cd /root/ALLInOne/tools/file && curl -LO https://github.com/findomain/findomain/releases/latest/download/findomain-linux-i386.zip > /dev/null 2>&1 && unzip /root/ALLInOne/tools/file/findomain-linux-i386.zip && chmod +x findomain > /dev/null 2>&1 && cp findomain /usr/bin/ && chmod  +x /usr/bin/findomain;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/Dheerajmadhukar/Lilly.git  > /dev/null 2>&1 && cd Lilly && chmod +x lilly.sh;
	...
	#cd /root/ALLInOne/tools && git clone --recursive https://github.com/screetsec/Sudomy.git > /dev/null 2>&1 && cd Sudomy && python3 -m pip install -r requirements.txt && apt-get install npm && apt-get install jq && npm install -g phantomjs && apt-get install jq nmap phantomjs npm chromium parallel -y && npm i -g wappalyzer wscat && cp sudomy /usr/local/bin && cp sudomy.api /usr/local/bin && cp slack.conf /usr/local/bin && cp sudomy.conf /usr/local/bin > /dev/null 2>&1 && ln -s /root/ALLInOne/tools/Sudomy/sudomy /usr/local/bin/;
	...
	cd /root/ALLInOne/tools/file && git clone https://github.com/joda32/CertCrunchy.git > /dev/null 2>&1 && cd CertCrunchy && sudo pip3 install -r requirements.txt;
	echo -e ${BLUE}"[SUBDOMAINS ENUMERATION]" ${RED}CertCrunchy installation in progress ...";
	#chaos
	...
	cd /root/ALLInOne/tools && git clone https://github.com/Josue87/AnalyticsRelationships.git  > /dev/null 2>&1 && cd AnalyticsRelationships && go build -ldflags "-s -w"; 
...
DNS_RESOLVER () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/blechschmidt/massdns.git > /dev/null 2>&1 && cd massdns && make && make install > /dev/null 2>&1 && ln -s /root/ALLInOne/tools/massdns/bin/massdns /usr/local/bin/;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/vortexau/dnsvalidator.git > /dev/null 2>&1 && cd dnsvalidator && python3 setup.py install &&  pip3 install contextvars && pip3 install -e . > /dev/null 2>&1 && ln -s /root/ALLInOne/tools/dnsvalidator/dnsvalidator /usr/local/bin/;
...
VISUAL_tools () {
	#Aquatone
	echo -e ${BLUE}"[VISUAL /root/ALLInOne/tools]" ${RED}"Aquatone installation in progress ...";
	cd /root/ALLInOne/tools/file && wget install https://github.com/michenriksen/aquatone/releases/download/v$AQUATONEVER/aquatone_linux_amd64_$AQUATONEVER.zip > /dev/null 2>&1 && unzip aquatone_linux_amd64_$AQUATONEVER.zip > /dev/null 2>&1 && mv aquatone /usr/local/bin/;
	echo -e ${BLUE}"[VISUAL /root/ALLInOne/tools]" ${GREEN}"Aquatone installation is done !"; echo "";
	#Gowitness
	echo -e ${BLUE}"[VISUAL /root/ALLInOne/tools]" ${RED}"Gowitness installation in progress ...";
	go install github.com/sensepost/gowitness@latest > /dev/null 2>&1 && ln -s ~/go/bin/gowitness chmod +x /usr/local/bin/;
	echo -e ${BLUE}"[VISUAL /root/ALLInOne/tools]" ${GREEN}"Gowitness installation is done !"; echo "";
}
...
WEB_CRAWLING () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/devanshbatham/ParamSpider > /dev/null 2>&1 && cd ParamSpider && pip3 install -r requirements.txt 
	...
	cd /root/ALLInOne/tools && git clone https://github.com/bp0lr/gauplus.git && cd gauplus && go build && mv gauplus /usr/local/bin/;
	...
	cd /root && mkdir -p .gf &&  cd /root/ALLInOne/tools/file && git clone https://github.com/tomnomnom/gf && cd /root/ALLInOne/tools/file/gf/examples && cp *.json $HOME/.gf && cd /root/ALLInOne/tools/file && git clone https://github.com/1ndianl33t/Gf-Patterns && cd /root/ALLInOne/tools/file/Gf-Patterns && cp *.json $HOME/.gf; 
	echo -e ${BLUE}"[WEB CRAWLING]" ${GREEN}"GF_P installation in progress ...";
	#uar
	echo -e ${BLUE}"[WEB CRAWLING]" ${RED}"GF_P installation in progress ...";
	cd /root/ALLInOne/tools/file && wget https://github.com/s0md3v/uro/archive/refs/tags/1.0.0-beta.zip && unzip 1.0.0-beta.zip && cd uro-1.0.0-beta && python3 setup.py install && cp -r  uro /usr/bin; 
	echo -e ${BLUE}"[WEB CRAWLING]" ${GREEN}"GF_P installation in progress ...";
	#freq
	echo -e ${BLUE}"[WEB CRAWLING]" ${RED}"freq installation in progress ...";
...
NETWORK_SCANNER () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/robertdavidgraham/masscan > /dev/null 2>&1 && cd masscan && make > /dev/null 2>&1 && make install > /dev/null 2>&1 && mv bin/masscan /usr/local/bin/;
...
HTTP_PARAMETER () {
	...
	pip3 install arjun > /dev/null 2>&1;
        cd /root/ALLInOne/tools/file && git clone https://github.com/edduu/Arjun.git;
...
LFI_TOOLS () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/D35m0nd142/LFISuite.git > /dev/null 2>&1;
...
SSRF_TOOLS () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/swisskyrepo/SSRFmap > /dev/null 2>&1 && cd SSRFmap && pip3 install -r requirements.txt > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/tarunkant/Gopherus.git > /dev/null 2>&1 && cd Gopherus && chmod +x install.sh && ./install.sh > /dev/null 2>&1;
...
Http-Request-Smuggling () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/anshumanpattnaik/http-request-smuggling.git > /dev/null 2>&1 && cd http-request-smuggling && pip3 install -r requirements.txt > /dev/null 2>&1;
...
SSTI_TOOLS () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/epinna/tplmap.git > /dev/null 2>&1 && cd tplmap && pip install -r requirements.txt > /dev/null 2>&1;
...
API_TOOLS () {
	...
	cd /root/ALLInOne/tools/file && wget install https://github.com/assetnote/kiterunner/releases/download/v"$KITERUNNERVER"/kiterunner_"$KITERUNNERVER"_linux_amd64.tar.gz > /dev/null 2>&1 && tar xvf kiterunner_"$KITERUNNERVER"_linux_amd64.tar.gz > /dev/null 2>&1 && mv kr /usr/local/bin;
	cd /root/ALLInOne/tools && mkdir -p kiterunner-wordlists && cd kiterunner-wordlists && wget install https://wordlists-cdn.assetnote.io/data/kiterunner/routes-large.kite.tar.gz > /dev/null 2>&1 && wget install https://wordlists-cdn.assetnote.io/data/kiterunner/routes-small.kite.tar.gz > /dev/null 2>&1 && for f in *.tar.gz; do tar xf "$f"; rm -Rf "$f"; done
...
VULNS_XSS () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/s0md3v/XSStrike > /dev/null 2>&1 && cd XSStrike && pip3 install -r requirements.txt > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && wget https://github.com/tomnomnom/hacks/archive/refs/heads/master.zip && unzip master.zip && cd hacks-master/kxss/ && go env -w GO111MODULE=auto && go build && cp kxss /usr/local/bin;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/dwisiswant0/findom-xss.git > /dev/null 2>&1 && cd findom-xss && chmod +x findom-xss.sh && rm -r LinkFinder && git clone https://github.com/GerbenJavado/LinkFinder.git > /dev/null 2>&1;
...
VULNS_SQLI () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/codingo/NoSQLMap.git > /dev/null 2>&1 && cd NoSQLMap && python setup.py install > /dev/null 2>&1;
	echo -e ${BLUE}"[VULNERABILITY - SQL Injection]" ${GREEN}"NoSQLMap installation is done !"; echo "";
	#ghauri
	echo -e ${BLUE}"[VULNERABILITY - SQL Injection]" ${RED}"NoSQLMap installation in progress ...";
	cd /root/ALLInOne/tools && git clone https://github.com/r0oth3x49/ghauri.git > /dev/null 2>&1 && cd ghauri && python3 -m pip install --upgrade -r requirements.txt && python3 -m pip install -e . > /dev/null 2>&1;
	echo -e ${BLUE}"[VULNERABILITY - SQL Injection]" ${GREEN}"NoSQLMap installation is done !"; echo "";
...
CMS_SCANNER () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/0ang3el/aem-hacker.git > /dev/null 2>&1 && cd aem-hacker && pip3 install -r requirements.txt > /dev/null 2>&1;
...
VULNS_SCANNER () {
	...
	cd /root/ALLInOne/tools && wget https://github.com/projectdiscovery/nuclei/releases/download/v2.9.7/nuclei_2.9.7_linux_amd64.zip && unzip nuclei_2.9.7_linux_amd64.zip > /dev/null 2>&1 && ln -s ~/go/bin/nuclei /usr/local/bin/;
	...
	cd /root/ALLInOne/tools/file && wget https://github.com/jaeles-project/jaeles/releases/download/beta-v0.17/jaeles-v0.17-linux.zip > /dev/null 2>&1 && unzip jaeles-v0.17-linux.zip > /dev/null 2>&1 && mv jaeles /usr/local/bin/;
...
JS_HUNTING () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/GerbenJavado/LinkFinder.git > /dev/null 2>&1 && cd LinkFinder && pip3 install -r requirements.txt > /dev/null 2>&1 && python3 setup.py install > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/m4ll0k/SecretFinder.git > /dev/null 2>&1 && cd SecretFinder && pip3 install -r requirements.txt && pip3 install jsbeautifier && pip3 install lxml > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/dark-warlord14/JSScanner > /dev/null 2>&1 && cd JSScanner/ && bash install.sh > /dev/null 2>&1;
...
GIT_HUNTING() {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/obheda12/GitDorker.git > /dev/null 2>&1 && cd GitDorker && pip3 install -r requirements.txt > /dev/null 2>&1;
	echo -e ${BLUE}"[GIT HUNTING]" ${GREEN}"gitGraber installation is done !"; echo "";
	#gitGraber
	echo -e ${BLUE}"[GIT HUNTING]" ${RED}"gitGraber installation in progress ...";
	cd /root/ALLInOne/tools && git clone https://github.com/hisxo/gitGraber.git > /dev/null 2>&1 && cd gitGraber && pip3 install -r requirements.txt > /dev/null 2>&1;
	echo -e ${BLUE}"[GIT HUNTING]" ${GREEN}"gitGraber installation is done !"; echo "";
	#GitHacker
	...
	cd /root/ALLInOne/tools && git clone https://github.com/internetwache/GitTools.git > /dev/null 2>&1;
...
SENSITIVE_FINDING() {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/securing/DumpsterDiver.git > /dev/null 2>&1 && cd DumpsterDiver && pip3 install -r requirements.txt > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/americanexpress/earlybird.git > /dev/null 2>&1 && cd earlybird && ./build.sh > /dev/null 2>&1 && ./install.sh > /dev/null 2>&1;
	...
	cd /root/ALLInOne/tools && git clone https://github.com/tamimhasan404/Gau-Expose.git > /dev/null 2>&1
...
cd /root/ALLInOne/tools && git clone https://github.com/gokulapap/wappalyzer-cli  > /dev/null 2>&1 && cd wappalyzer-cli && pip3 install . > /dev/null 2>&1;
echo -e ${BLUE}"[USEFUL TOOLS]" ${RED}"wappalyzer-cli installation in progress ...";
}
...
USEFUL_TOOLS () {
	...
	cd /root/ALLInOne/tools && git clone https://github.com/codingo/Interlace.git > /dev/null 2>&1 && cd Interlace && python3 setup.py install > /dev/null 2>&1;
